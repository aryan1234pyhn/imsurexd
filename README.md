...
<details>
  ...
  *There are many public ones out there for example lava.link*
  ...
  1. Make sure `Java 11` is installed on your system!
     ...
     * [Click here for a Download for **Windows**](https://downloads./windows/java/jdk-11.0.11.exe) ​
...
> Example: `Bot Coded by [Itachi#2711](https://discord.gg/dcdev) but modified by [modifier/your Name](https://discord.gg/)`
