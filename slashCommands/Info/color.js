  ...
  run: async (client, interaction, cmduser, es, ls, prefix, player, message) => {
    ...
    let color = options.getString("color");
      ...
      const embed = new Discord.MessageEmbed()
        ...
        .addField('<a:Arrow_White:958439715944677426> **Name**', json.name, true)
        .addField("<a:Arrow_White:958439715944677426> **Hex**", json.hex, true)
        .addField("<a:Arrow_White:958439715944677426> **RGB**", json.rgb, true)
        .addField(`<a:Arrow_White:958439715944677426> **${client.la[ls].cmds.info.color.brightershade}**`, json.brightened, true)
