  ...
  run: async (client, interaction, cmduser, es, ls, prefix, player, message) => {
    ...
    if (customavatar) {
      let embed = new MessageEmbed()
        ...
        .addField("<a:Arrow_White:958439715944677426> PNG", `[\`LINK\`](${customavatar})`, true)
        .addField("<a:Arrow_White:958439715944677426> JPEG", `[\`LINK\`](${customavatar.replace("png", "jpg").replace("gif", "jpg")})`, true)
        .addField("<a:Arrow_White:958439715944677426> WEBP", `[\`LINK\`](${customavatar.replace("png", "webp").replace("gif", "webp")})`, true)
        .setURL(customavatar)
      ...
      let embed = new MessageEmbed()
        ...
        .setColor(es.color).setThumbnail(es.thumb ? es.footericon && (es.footericon.includes("http://") || es.footericon.includes("https://")) ? es.footericon : client.user.displayAvatarURL() : null)
        .addField("<a:Arrow_White:958439715944677426> PNG", `[\`LINK\`](${user.displayAvatarURL({format: "png"})})`, true)
        .addField("<a:Arrow_White:958439715944677426> JPEG", `[\`LINK\`](${user.displayAvatarURL({format: "jpg"})})`, true)
        .addField("<a:Arrow_White:958439715944677426> WEBP", `[\`LINK\`](${user.displayAvatarURL({format: "webp"})})`, true)
