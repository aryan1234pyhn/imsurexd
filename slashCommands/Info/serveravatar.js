...
module.exports = {
  ...
  run: async (client, interaction, cmduser, es, ls, prefix, player, message) => {
    ...
    try {
      ...
      .addField("<a:Arrow_White:958439715944677426> PNG",`[\`LINK\`](${guild.iconURL({format: "png"})})`, true)
      .addField("<a:Arrow_White:958439715944677426> JPEG",`[\`LINK\`](${guild.iconURL({format: "jpg"})})`, true)
      .addField("<a:Arrow_White:958439715944677426> WEBP",`[\`LINK\`](${guild.iconURL({format: "webp"})})`, true)
